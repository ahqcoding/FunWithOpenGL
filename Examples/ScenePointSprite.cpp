...
void ScenePointSprite::init()
{
    prog.compileShader("shaders/pointsprite.vert.glsl",
        "shaders/pointsprite.frag.glsl",
        "shaders/pointsprite.geo.glsl");
    prog.use();
...
void ScenePointSprite::onMouseMove(double xpos, double ypos)
{
}

void ScenePointSprite::onMouseScroll(double xoffset, double yoffset)
{
}

void ScenePointSprite::onMouseButton(int button, int action)
{
}

void ScenePointSprite::onKey(int key, int action)
{
}

Camera* ScenePointSprite::getCamera()
{
    return nullptr;
}
